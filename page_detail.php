        ...
        <div class="col-lg-4 mb-lg-0 mb-4">
          <div class="card p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">Detail Data </h6><a style="color:white" class="btn btn-<?= $warna ?>"><?= $text ?></a>
            </div>
            <div class="card-body">
            <?php if(empty($uid)){ ?>
            <center><a style="color:red">Verifikasi KTP belum dilakukan</a></center>
            <?php } ?>
            <form method="post" action="action.php">
            <input type="text" name="action" id="action" value="detail" hidden>
            <input type="text" name="id" id="id" value="<?= $id ?>" hidden>
              <div class="row">
              <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">NIK</label>
                    <input class="form-control" type="text" name="nik" id="nik" value="<?= $hasilku['nik']; ?>"  readonly required>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">NAMA</label>
                    <input class="form-control" type="text" name="nama" id="nama" value="<?= $hasilku['nama']; ?>"  required>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">GENDER</label>
                    <input class="form-control" type="text" name="gender" id="gender" value="<?= $hasilku['gender']; ?>"  readonly required>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">ALAMAT</label>
                    <input class="form-control" type="text" name="alamat" id="alamat" value="<?= $hasilku['alamat']; ?>"  required>
                  </div>
                </div>                
                </br><Center>
              <input type="submit" style="color:white" class="btn btn-primary" name="submit" value="Update"> <a href="action_delete.php?id=<?= $id ?>" style="color:white" class="btn btn-danger" >Delete</a>
             </div>
            </form>
          </div>
        </div>
