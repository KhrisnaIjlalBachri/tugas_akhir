...
//Cek Detail
$tampil = mysqli_query($koneksi, "SELECT * FROM admin WHERE id='1'");
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item ">
          <a class="nav-link active" href="page_profil.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="col-lg-4 mb-lg-0 mb-4">
          <div class="card p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">Edit Profil </h6>
            </div>
            <div class="card-body">
            <form method="post" action="action.php">
            <input type="text" name="action" id="action" value="profil" hidden>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">USERNAME</label>
                    <input class="form-control" type="text" name="username" id="username" value="<?= $hasilku['username']; ?>" readonly required>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">PASSWORD</label>
                    <input class="form-control" type="text" name="password" id="password" placeholder="Input password" value="<?= $hasilku['password']; ?>"required>
                  </div>
                </div>
                </br><Center>
              <input type="submit" style="color:white" class="btn btn-primary" name="submit" value="Update">
             </div>
            </form>
          </div>
        </div>
